...
export const Route = createFileRoute("/features/deliverability")({
  head: () => {
    const category = getCategory("deliverability")!;
    return ({
    meta: [
...
function FeatureRoute() {
  return <FeaturePage category={getCategory("deliverability")!} />;
}