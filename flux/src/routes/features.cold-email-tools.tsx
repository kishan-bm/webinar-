...
export const Route = createFileRoute("/features/cold-email-tools")({
  head: () => {
    const category = getCategory("cold-email-tools")!;
    return ({
    meta: [
...
function FeatureRoute() {
  return <FeaturePage category={getCategory("cold-email-tools")!} />;
}