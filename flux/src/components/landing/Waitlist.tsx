...
export function Waitlist() {
  ...
  return (
    <section id="waitlist" className="relative overflow-hidden bg-white py-20">
      <div className="pointer-events-none absolute inset-0 grid-bg opacity-70" />
      <div className="relative mx-auto max-w-4xl px-6">
        <div className="relative overflow-hidden rounded-[2rem] px-8 py-10 text-center sm:px-16" style={{ background: "#0D2E4E" }}>
          ...
          <div className="relative">
            ...
            <h2 className="mt-3 font-display text-3xl leading-[1.05] text-white text-balance md:text-5xl">
            ...
            <form onSubmit={(e) => { e.preventDefault(); if (email) setSubmitted(true); }} className="mx-auto mt-6 flex max-w-xl flex-col items-stretch gap-2 rounded-2xl border border-white/15 bg-white/5 p-2 backdrop-blur sm:flex-row">
